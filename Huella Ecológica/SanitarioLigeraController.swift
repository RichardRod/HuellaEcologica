//
//  SanitarioLigeraController.swift
//  Huella Ecológica
//
...
class SanitarioLigeraController: UIViewController, UITextFieldDelegate {
    ...
    func obtenerTextoVeces(textField: UITextField) {
        ...
        if textField.text?.characters.count > 0 {
            DatosHidricaLigera.sanitario.descargas = Int(txtVeces.text!)!
        } else {
            DatosHidricaLigera.sanitario.descargas = 0
        }
    }
